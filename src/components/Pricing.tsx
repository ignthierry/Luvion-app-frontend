            ...
            {tiers?.map((tier, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-10">
                    <a
                      href={`https://wa.me/628197965599?text=${encodeURIComponent(`Halo Luvion, saya tertarik dengan paket ${tier.name} untuk bisnis saya. Boleh minta info lebih lanjut?`)}`}
                      target="_blank"
                      rel="noreferrer"
                    ...
                    >
                      ...
                      {tier.id === 'Enterprise' ? 'Hubungi Sales via WA' : 'Mulai Sekarang'}
                    </a>
                  </div>
                </motion.div>
              );
